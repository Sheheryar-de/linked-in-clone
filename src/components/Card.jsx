    ...
    <>
      <div className="hidden sticky top-0  border-[1px] border-slate-200 rounded-lg overflow-hidden md:block md:w-[150px] h-[max-content] lg:w-[220px] bg-white">
        <div className=" md:flex md:flex-col md:items-center ">
          ...
          <p className="text-xs text-gray-500 lg:text-sm font-sans mt-[7px]">
            {title}
          </p>
        ...
        <p className="text-[12px] font-bold flex items-center py-[10px] lg:text-[15px] w-[93%] mx-[auto]">
          <TurnedInNotOutlinedIcon fontSize="small" /> Saved Items
        </p>
      </div>
    </>
  );
